...
#         # Majority direction in each window
#         prefix_majority = max(set(prefix_dirs), key=prefix_dirs.count)
#         suffix_majority = max(set(suffix_dirs), key=suffix_dirs.count)
...
#         # -- gesture change --
#         if finger_change >= 1 and finger_change < 5: # arbitrary threshold for multiple fingers changing
#             return "bending_fingers"
        
#         if finger_change >= 4: # all fingers
#             return "hand_open_and_close"
